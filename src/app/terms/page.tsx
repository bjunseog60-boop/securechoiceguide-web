...
export const metadata: Metadata = {
  ...
  description: 'SecureChoiceGuide terms of service -- rules and guidelines for using our website.',
};
  ...
  return (
    <div className="pt-12 max-w-3xl mx-auto">
      ...
      <div className="prose-style">
        <p>By accessing and using SecureChoiceGuide (&quot;the Site&quot;), you accept and agree to be bound by these Terms of Service.</p>
        ...
        <p>
          All content on this Site, including text, graphics, logos, and images, is the property of SecureChoiceGuide or its content suppliers and is protected by copyright laws. You may not reproduce, distribute, or create derivative works without our express written consent.
        </p>
        ...
        <p>
          To the fullest extent permitted by applicable law, SecureChoiceGuide shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or relating to your use of the Site.
        </p>

        <h2>Indemnification</h2>
        <p>
          You agree to indemnify and hold harmless SecureChoiceGuide and its affiliates from any claims, damages, or expenses arising from your use of the Site or violation of these Terms.
        </p>
        ...
        <h2>Contact</h2>
        <p>
          Questions about these Terms? Contact us at <a href="mailto:contact@securechoiceguide.com">contact@securechoiceguide.com</a>.
        </p>
      </div>
    </div>
  );

    ...
    <div className="pt-12 max-w-2xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-10">
        <div className="border border-gray-100 rounded-xl p-6 bg-white">
          ...
          <a href="mailto:contact@securechoiceguide.com" className="text-sm text-gray-900 font-medium hover:text-gray-600 transition-colors">
      ...
      <div className="border border-gray-100 rounded-xl p-6 bg-white">
        ...
        <a href="mailto:contact@securechoiceguide.com" className="btn-primary text-sm inline-block">Send Partnership Inquiry</a>
      </div>
    </div>
  );
}

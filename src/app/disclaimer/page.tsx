...
export const metadata: Metadata = {
  ...
  description: 'SecureChoiceGuide disclaimer, affiliate disclosure, and FTC compliance information.',
};
    ...
    <div className="pt-12 max-w-3xl mx-auto">
      ...
      <div className="prose-style">
        ...
        <ul className="list-disc pl-6 space-y-1 text-gray-600 text-sm mb-4">
          <li><strong>SecureChoiceGuide is a participant in the Amazon Services LLC Associates Program</strong>, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com.</li>
        ...
        <h2>DMCA Notice</h2>
        <p>
          If you believe that content on this website infringes your copyright, please send a DMCA notice to <a href="mailto:contact@securechoiceguide.com">contact@securechoiceguide.com</a>. We will respond to legitimate DMCA requests promptly.
        </p>

        <h2>Contact</h2>
        <p>
          Questions about this disclaimer? Contact us at <a href="mailto:contact@securechoiceguide.com">contact@securechoiceguide.com</a>.
        </p>
      </div>
    </div>
  );
